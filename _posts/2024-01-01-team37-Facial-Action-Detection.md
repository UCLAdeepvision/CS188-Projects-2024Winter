...
- $$\hat{y}_{mathrm{2j-1}}$$ and $$\hat{y}_{2j}
...
$$E_r = -\sum_{i=1}^{n_{\mathrm{au}}} \sum_{k=1}^{n_{\mathrm{am}}} \left[ v_{\mathrm{ik}} \log \hat{v}_{mathrm{ik}} + (1 - v_{mathrm{ik}}) \log (1 - \hat{v}_{ik}) \right]$$
